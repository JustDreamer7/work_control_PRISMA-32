...
class GraphsDrawing:
    def __init__(self, start_date, end_date, path_to_pic):
        ...
        if end_date - start_date > datetime.timedelta(weeks=25):
            ...
            self.leg_linewidth, self.linewidth = 8, 4
            self.marker_size, self.xticks_spaces = 8, 25
    ...
    def amp_5_fr_4_graph(self, amp_5_fr_4_frame, amp_5_fr_4_frame_2):
        ...
        plt.plot(amp_5_fr_4_frame['Date'], amp_5_fr_4_frame['Events'], label='1 Кл.',
                 marker='s', markersize=self.marker_size, color='darkblue', linewidth=self.linewidth)
        plt.plot(amp_5_fr_4_frame_2['Date'], amp_5_fr_4_frame_2['Events'], label='2 Кл.',
        ...
        for i in range(1, 17):
            plt.plot(amp_distribution_frame[amp_distribution_frame[f'amp{i}'] >= a_crit][
                     ...
                     amp_distribution_frame[amp_distribution_frame[f'amp{i}'] >= a_crit][
                         f'amp{i}'].value_counts().sort_index(), label=f'{i}', linewidth=4)
        self.legend_design()
    ...
    def count_rate_graph(self, count_rate_frame, cluster, a_crit, freq):
